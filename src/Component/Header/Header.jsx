...
import headerImage from '../../assets/header_img.png'; // Adjust path as needed

const Header = () => {
  return (
    <div
      className="relative h-[34vw] mx-auto mt-[30px] bg-no-repeat bg-contain"
    ...
    >
      <div className="absolute flex flex-col items-start gap-[1.5vw] max-w-[50%] bottom-[10%] left-[6vw] animate-[fadeIn_3s] md:max-w-[45%] lg:max-w-[65%]">
        ...
        <button
          className="bg-white text-gray-600 font-medium px-[2.3vw] py-[1vw] rounded-[50px] text-[max(1vw,13px)] hover:bg-brand-red hover:text-white transition-colors duration-300 cursor-pointer lg:px-[4vw] lg:py-[2vw]"
        >
          View Menu
        </button>
      </div>
